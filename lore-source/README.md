...
Welcome to the official **Decked Out Lore Bible**.
...
- **BRB (Before Reality Broke)**: The golden centuries of mortal civilization, the Five Empires, and elemental balance (e.g., `1000 BRB` to `1 BRB`).
- **0 RB (The Shatter)**: The single day mortal hubris ruptured the celestial firmament, detonated the Firmament Siphon, and raised Mount Calamity.
- **ARB (After Reality Broke)**: The dark era of the Great World War (`0–10 ARB`), the Age of Splinters (`11–24 ARB`), and the Crusade of the Champions (`25 ARB` onward).
...
1. **Aeth / Aether**: The primordial celestial quintessence—the pure, radiant upper firmament of the stars that exists beyond the mortal elements of earth, fire, water, and air.
2. **Telos**: The ultimate purpose, completion, cosmic destiny, and final cause of existence.
...
| **04** | [The Six Martial & Magical Orders](file:///c:/Users/ellul/Documents/decked-out/lore/04_the_six_orders.md) | `Wartime` | The living wartime factions: Alchemists, Wild Mages, Iron Vanguard, Primal Beasts, Abyssal Horrors, and Goblin Scrappers. |
| **05** | [Chronicles of the Champions](file:///c:/Users/ellul/Documents/decked-out/lore/05_chronicles_of_the_champions.md) | `5–25 ARB` | The individual war origin stories of each hero: Deck Monk, Gabe, Hunter, Necri, Lost Spirit, Demonling, Scrap Goblin, and the Dragon. |
| **06** | [Denizens of the Wasteland](file:///c:/Users/ellul/Documents/decked-out/lore/06_denizens_of_the_threshold.md) | `Present` | Neutral survivors of the war: The Trader (smuggler), The Chemist (apothecary), The Gambler (profiteer), and battle altars. |
| **07** | [Mount Calamity & Aethelos the Slumbering God](file:///c:/Users/ellul/Documents/decked-out/lore/07_the_dragon_lord_and_the_god.md) | `Ongoing` | Mount Calamity, the apex Dragon Lord, the Celestial Rift, the living siege of Aethelos, and why the war continues today. |
...
- **Before the Cataclysm (10 BRB)**: [`map_before_war.jpg`](file:///c:/Users/ellul/Documents/decked-out/lore/maps/map_before_war.jpg)
- **After the Shattering (25 ARB)**: [`map_after_war.jpg`](file:///c:/Users/ellul/Documents/decked-out/lore/maps/map_after_war.jpg)
